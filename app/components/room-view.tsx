          ...
          <div className="flex flex-wrap items-center justify-between gap-5">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="button"
                onClick={() => router.push("/")}
                className="syncplay-button-secondary rounded-full border border-white/10 bg-white/6 px-3 py-1 text-xs font-semibold text-slate-100 transition hover:bg-white/10"
              >
                Leave room
              </button>
            </div>
